...
const TECH_STACK = ["React", "Javascript", "Node.js","Asp.Net","AWS"];
const SOCIAL_LINKS = [
  { icon: Github, link: "https://github.com/Cuong333" },
  { icon: Linkedin, link: "https://www.linkedin.com/in/dang-hung-cuong-be27" },
